...
import { Calendar, Check, Download, Edit3, File, Heart, Info, MessageCircle, RotateCw, Save, Trash2, User, WandSparkles, X } from "lucide-react";
import { format } from "date-fns";
import { ru } from "date-fns/locale";
import clsx from "clsx";
import type { Album, Asset } from "@/components/types";
import type { User as ArchiveUser } from "@/components/types";
...
export default function AssetViewer({ asset, albums, currentUser, onClose, onUpdate, onDelete }: { asset: Asset; albums: Album[]; currentUser: ArchiveUser; onClose: () => void; onUpdate: (asset: Asset) => void; onDelete: () => void }) {

...
- папки с обложками из последних фото, аудио и файлов, красивые альбомы с несколькими вариантами обложек;
- переименование семейных папок и альбомов прямо из карточки или открытой коллекции;
